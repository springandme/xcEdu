...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PUBLISH_COURSEBASEISNULL(false, 31006, "没有该课程基本信息"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false, 31007, "没有该课程计划基本信息"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false, 31008, "该课程的难度的等级错误"),
